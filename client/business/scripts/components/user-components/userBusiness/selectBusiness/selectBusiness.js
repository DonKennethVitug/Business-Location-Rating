var selectBusinessServicesApp = angular.module('selectBusiness.controller', [])

.controller('selectBusinessCtrl', function($scope, $window, $state, $http, $rootScope, $timeout, mapServices, $interval, $cookieStore, $vitug_algorithm) {
